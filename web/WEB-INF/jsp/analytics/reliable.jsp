...
<head>
    <meta charset="UTF-8">
    <title>Most Reliable Mangaka</title>
...
<h2 class="page-title">Most Reliable Mangaka</h2>
<p class="page-sub">Based on on-time submissions and deadline adherence</p>

<div class="section-card">
    <h3 class="section-title compact-title">Filters</h3>
    <form method="get" action="${pageContext.request.contextPath}/main/analytics/reliable" class="form-grid">
...
<c:if test="${not empty results}">
    <div class="section-card">
        ...
        <table class="data-table">
            <thead><tr><th>Rank</th><th>Mangaka</th><th>Reliability</th><th>Popularity</th><th>Quality</th><th>Overall</th><th>Badge</th></tr></thead>
            <tbody>
