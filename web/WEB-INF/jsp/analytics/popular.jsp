...
<head>
    <meta charset="UTF-8">
    <title>Top Popular Mangaka</title>
...
<h2 class="page-title">Top Popular Mangaka</h2>
<p class="page-sub">Based on series ranking and reader votes</p>

<div class="section-card">
    <h3 class="section-title compact-title">Filters</h3>
    <form method="get" action="${pageContext.request.contextPath}/main/analytics/popular" class="form-grid">
